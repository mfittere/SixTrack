...
C=================================================================
      ...
      PARAMETER (MMAX=6)
CU    USES LUBKSB_PLATO,LUDCMP_PLATO
 ...
 13     CONTINUE
 14   CONTINUE
      CALL LUDCMP_PLATO(A,M+1,MMAX+1,INDX,D)
      DO 15 J=1,M+1
        B(J)=0.D0
 15   CONTINUE
      B(LD+1)=1.D0
      CALL LUBKSB_PLATO(A,M+1,MMAX+1,INDX,B)
      DO 16 KK=1,NP
        C(KK)=0.D0
 16   CONTINUE
      DO 18 K=-NL,NR
...
CDECK  ID>, LUBKSB_PLATO.
C=================================================================

      SUBROUTINE LUBKSB_PLATO(A,N,NP,INDX,B)
      INTEGER N,NP,INDX(N)
 ...
 14   CONTINUE
      ...
      END
C  (C) Copr. 1986-92 Numerical Recipes Software B2..
CDECK  ID>, LUDCMP_PLATO.
C=================================================================

      SUBROUTINE LUDCMP_PLATO(A,N,NP,INDX,D)
 ...
 11     CONTINUE
        IF (AAMAX.EQ.0.D0) PAUSE 'SINGULAR MATRIX IN LUDCMP_PLATO'
        VV(I)=1.D0/AAMAX
 12   CONTINUE
      DO 19 J=1,N
        DO 14 I=1,J-1
...
C
      ...
      COMMON/LATICE/IA(NELE),A(NELE,5),ALBL(NELE),IMAX
      COMMON/VZLUMP/RL(4,4,NLUMP),RK(4,NLUMP),INL(2,NLUMP),NLMAX
      COMMON/LINOPT_PLATO/OPTICS(7,NELE),DIST(NELE),NAME(NELE),IFILL,NREC
C.............................................................
